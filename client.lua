...
RegisterNetEvent("NHdisconnect:show")
AddEventHandler("NHdisconnect:show", function()
    if show3DText then
        show3DText = false
    else
        show3DText = true
...
RegisterNetEvent("NHdisconnect")
AddEventHandler("NHdisconnect", function(id, crds, identifier, reason)
